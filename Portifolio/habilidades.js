...
const sobreSkill = [
                    ...
                    '<p>Java</p> <br> <p>É uma linguagem de programação rápida, segura e confiável para codificar tudo, desde aplicações móveis e software empresarial até aplicações de big data e tecnologias do servidor.</p> <br>',
                    '<p>SQL</p> <br> <p>É uma linguagem padrão para manipulação de registros em bancos de dados relacionais.</p> <br>',
